...
import 'package:shop/ui/widgets/product_details_widgets/product_details_widget.dart';
...
class ProductDetailsScreen extends StatefulWidget {
  ...
  MyProductUserResponseModel? myProductUserResponseModel;
//  String? id;
  ProductDetailsScreen({Key? key,required this.product,this.myProductUserResponseModel}) : super(key: key);
...
class _ProductDetailsScreenState extends State<ProductDetailsScreen> {
  ...
  void initState() {
    ...
    // }else {
    //   BlocProvider.of<ProductDetailsCubit>(context)
    //       .getProductDetailsUser('${widget.id}');
    // }
    if(widget.product.id == null){
    ...
    // fetchLinkData();
    // translationProduct('${widget.product.name}');
    //
    // translator.translate('${widget.product.description}', from: 'en', to: 'ar').then((s) {
    //   print('translation  $s');
    // });
  }
                                              ...
                                              AddButtonWidget(
                                                child: IconButton(
                                                    ...
                                                    onPressed: () async {
                                                      ...
                                                      // await FirebaseDynamicLinkService.createDynamicLinkProduct(
                                                      ...
                                                      child: Column(
                                                        children: [
                                                          Row(
                                                            ...
                                                            children: [
                                                              Productstate.showDetailsProductResponseModel![0].user?.photo == null
                                                                  ? Container(
                                                                width: 40.h,
                                                                height: 42.h,
