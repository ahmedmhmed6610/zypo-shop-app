...
class ProductFilterDetailsScreen extends StatefulWidget {
  MyProductUserResponseModel? product;
  int? productId;
  String? location;
  ProductFilterDetailsScreen({Key? key, required this.productId,this.location,this.product}) : super(key: key);

  @override
  State<ProductFilterDetailsScreen> createState() => _ProductFilterDetailsScreenState();
}

class _ProductFilterDetailsScreenState extends State<ProductFilterDetailsScreen> {
  ...
  void initState() {
    ...
    BlocProvider.of<ProfileCubit>(context).getUserProfile() : null;
    BlocProvider.of<AppLayoutCubit>(context).checkConnectionInternet();
    userId = CacheHelper.getData(key: 'UserId');

    print('product id filter ');
    print('${widget.product?.id}');
    // translator.translate('${widget.location}', to: 'ar')
    //     .then((result){
    //   print("Source: typeBusiness ${widget.location}\nTranslated: $result");
    //   locationUser  = result.toString();
    //   print('Translated: kids $locationUser');
    //
    // });
                      ...
                      Expanded(
                          child: ListView(
                            ...
                            children: [
                              10.heightBox,
                              ProductImagesSlider(
                                images: Productstate.showDetailsProductResponseModel![0].photoList!,
                                phoneNumber: '${Productstate.showDetailsProductResponseModel![0].user?.phoneNumber}',
                                productName:  '${Productstate.showDetailsProductResponseModel![0].name}',
                                whatsAppNumber: '${Productstate.showDetailsProductResponseModel![0].whatsNumber}',
                                userId: Productstate.showDetailsProductResponseModel![0].user!.id!,
                              ),
                              7.heightBox,
                              Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Row(
                                      ...
                                      children: [
                                        Text('${Productstate.showDetailsProductResponseModel![0].name}',
                                          style: TextStyle(
                                            ...
                                            AddButtonWidget(
                                              child: IconButton(
                                                  ...
                                                  onPressed: () async {
                                                    ...
                                                    // await FirebaseDynamicLinkService.createDynamicLinkProduct2(
                                                    //     myProductUserResponseModel: widget.product);
                                                    //
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        10.widthBox,
                                        Productstate.showDetailsProductResponseModel![0]
                                            .oldPrice !=
                                            Productstate
                                    ...
                                    BlocBuilder<FilterCubit, FilterState>(
                                      builder: (context, state) {
                                        ...
                                        return BlocConsumer<AddFavoriteUserCubit,
                                            ...
                                            return GestureDetector(
                                              onTap: () {
                                                ...
                                                Navigator.of(context)
                                                  ...
                                                  builder: (context) =>
                                                      UserProductsScreen(
                                                        intentValue: 'homeProductDetails',
                                                        showDetailsProductResponseModel:
                                                        Productstate
                                                            .showDetailsProductResponseModel![0],
                                                      ),
                                    ...
                                    Column(
                                      children: [
                                        ...
                                        Productstate.showDetailsProductResponseModel![0]
                                          ...
                                          showDetailsProductResponseModel: Productstate
                                              .showDetailsProductResponseModel![0],
                                        )
                                            : Container(),
                                        Productstate.showDetailsProductResponseModel![0]
                                                    ...
                                                    actions: [
                                                      Padding(
                                                        ...
                                                        IconsButton(
                                                          ...
                                                          // color: Colors.transparent,
                                                          shape:
                                                          OutlineInputBorder(borderSide: const BorderSide(color: AppPalette.black), borderRadius: BorderRadius.circular(Dimensions.radiusDefault)),
                                                          textStyle:
                                                          const TextStyle(color: Colors.black),
                                                          padding:
                                                          EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeExtraSmall, vertical: Dimensions.paddingSizeDefault),
                                                        ),
                                                      ),
                                                      Padding(
                                                        padding:
                                                        ...
                                                        IconsButton(
                                                          ...
                                                          shape:
                                                          OutlineInputBorder(borderSide: BorderSide.none, borderRadius: BorderRadius.circular(Dimensions.radiusDefault)),
                                                          padding:
                                                          EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeExtraSmall, vertical: Dimensions.paddingSizeDefault),
                                                          // iconColor: Colors.white,
                                                        ),
    ...
    return showDetailsProductResponseModel.options!.isEmpty
      ...
      children: [
        ProductDetailsWidget(
          ...
          showDetailsProductResponseModel.options![0].valueAr :
          ''}',
        ),
        const Divider(color: AppPalette.grey),
      ],
        ...
        showDetailsProductResponseModel.options![1].value!
          ...
          children: [
            ProductDetailsWidget(
              ...
              showDetailsProductResponseModel.options![1].value :
              context.locale.languageCode.contains('ar') ?
              showDetailsProductResponseModel.options![1].valueAr :
              ''}',
            ),
            const Divider(color: AppPalette.grey),
          ],
        ...
        showDetailsProductResponseModel.options![2].value!
          ...
          children: [
            ProductDetailsWidget(
              ...
              showDetailsProductResponseModel.options![2].value :
              context.locale.languageCode.contains('ar') ?
              showDetailsProductResponseModel.options![2].valueAr :
              ''}',
            ),
            const Divider(color: AppPalette.grey),
          ],
        ...
        showDetailsProductResponseModel.options![3].value!
          ...
          children: [
            ProductDetailsWidget(
              ...
              showDetailsProductResponseModel.options![3].value :
              context.locale.languageCode.contains('ar') ?
              showDetailsProductResponseModel.options![3].valueAr :
              ''}',
            ),
            const Divider(color: AppPalette.grey),
          ],
        ...
        showDetailsProductResponseModel.options![4].value!
          ...
          children: [
            ProductDetailsWidget(
              ...
              showDetailsProductResponseModel.options![4].value :
              context.locale.languageCode.contains('ar') ?
              showDetailsProductResponseModel.options![4].valueAr :
              ''}',
            ),
            const Divider(color: AppPalette.grey),
          ],
        ...
        showDetailsProductResponseModel.options![5].value!
          ...
          children: [
            ProductDetailsWidget(
              ...
              showDetailsProductResponseModel.options![5].value :
              context.locale.languageCode.contains('ar') ?
              showDetailsProductResponseModel.options![5].valueAr :
              ''}',
            ),
            const Divider(color: AppPalette.grey),
          ],
        ...
        showDetailsProductResponseModel.options![6].value!
          ...
          children: [
            ProductDetailsWidget(
              ...
              showDetailsProductResponseModel.options![6].value :
              context.locale.languageCode.contains('ar') ?
              showDetailsProductResponseModel.options![6].valueAr :
              ''}',
            ),
            const Divider(color: AppPalette.grey),
          ],
        ...
        showDetailsProductResponseModel.options![7].value!
          ...
          children: [
            ProductDetailsWidget(
              ...
              showDetailsProductResponseModel.options![7].value :
              context.locale.languageCode.contains('ar') ?
              showDetailsProductResponseModel.options![7].valueAr :
              ''}',
            ),
          ],
        ),
        ...
        showDetailsProductResponseModel.options![8].value!
          ...
          children: [
            ProductDetailsWidget(
              ...
              showDetailsProductResponseModel.options![8].value :
              context.locale.languageCode.contains('ar') ?
              showDetailsProductResponseModel.options![8].valueAr :
              ''}',
            ),
          ],
        ),
