...
class HomeUserFavoriteProductsScreen extends StatefulWidget {
  HomeUserFavoriteProductsScreen({Key? key,required this.myFavoriteResponseModel}) : super(key: key);
  MyFavoriteUserResponseModel? myFavoriteResponseModel;
  @override
  _HomeUserFavoriteProductsScreenState createState() => _HomeUserFavoriteProductsScreenState();
}

class _HomeUserFavoriteProductsScreenState extends State<HomeUserFavoriteProductsScreen> {
  ...
  void initState() {
    ...
    BlocProvider.of<ProductDetailsCubit>(context).getProductDetails(
        productId: widget.myFavoriteResponseModel!.id!);
            ...
            BlocBuilder<FilterCubit, FilterState>(
              builder: (context, filterState) {
                ...
                if (filterState is FilterSuccessState) {
                  var listDate = widget.myFavoriteResponseModel?.user?.createdAt?.split(' ');
                                    ...
                                    child: Column(
                                      children: [
                                        Row(
                                          ...
                                          children: [
                                            widget.myFavoriteResponseModel!
                                                .user?.photo ==
                                                null
                                                ? Container(
                                              width: 40.h,
                                              ...
                                              BoxDecoration(
                                                  ...
                                                  DecorationImage(
                                                      image: CachedNetworkImageProvider(
                                                          '${widget.myFavoriteResponseModel?.user?.userImagePath}/'
                                                              '${widget.myFavoriteResponseModel?.user?.photo}'),
                                                      fit: BoxFit
                                                          .cover),
                                                  borderRadius:
                                                  BorderRadius.circular(
                                            ...
                                            Column(
                                              ...
                                              children: [
                                                2.heightBox,
                                                Text(
                                                  '${widget.myFavoriteResponseModel?.user?.firstName}'
                                                      ' ${widget.myFavoriteResponseModel?.user?.lastName}',
                                                      ...
                                                      child: IconButton(
                                                          ...
                                                          onPressed:
                                                              () async {
                                                                ...
                                                                // await FirebaseDynamicLinkService.createDynamicLinkUser2(
                                                                //     myProductUserResponseModel: widget.myFavoriteResponseModel);
                                                                //
                                                              ...
                                                              if (AppLocalStorage.token == null) {
                                                                ...
                                                                if(stateSubscribeDetails is SuccessProductDetailsState){
                                                                  if (stateSubscribeDetails.showDetailsProductResponseModel![0].isSubscriber == true) {
                                                                    myFavoriteUserCubit.deleteSubscribeUserProduct('${widget.myFavoriteResponseModel?.user!.id.toString()}');
                                                                  } else if (stateSubscribeDetails.showDetailsProductResponseModel![0].isSubscriber == false) {
                                                                    myFavoriteUserCubit.addSubscribeUserProduct('${widget.myFavoriteResponseModel?.user!.id.toString()}');
                                                                  }
                                                                }
                                                      ...
                                                      child: IconButton(
                                                          ...
                                                          onPressed:
                                                            ...
                                                            if (AppLocalStorage.token ==
                                                              ...
                                                              print('phone user');
                                                              print(widget.myFavoriteResponseModel?.user?.phoneNumber);
                                                              await callNumber(phoneNumber: '${widget.myFavoriteResponseModel?.user?.phoneNumber}');
                                                            }
                                                          },
                                                          icon: SvgPicture
                                                              .asset(
