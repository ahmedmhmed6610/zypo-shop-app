...
class ChooseFromKilometersScreen extends StatefulWidget {
  ...
  @override
  State<ChooseFromKilometersScreen> createState() => _ChooseFromKilometersScreenState();
}

class _ChooseFromKilometersScreenState extends State<ChooseFromKilometersScreen> {

  List<ColorModel> dummyKiloMeters = [
    ColorModel(id: 2, color: "0"),
    ColorModel(id: 3, color: "1000"),
    ColorModel(id: 4, color: "5000"),
    ColorModel(id: 5, color: "10000"),
    ColorModel(id: 6, color: "15000"),
    ColorModel(id: 7, color: "20000"),
    ColorModel(id: 8, color: "25000"),
    ColorModel(id: 9, color: "30000"),
    ColorModel(id: 10, color: "35000"),
    ColorModel(id: 11, color: "40000"),
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      //   toArea: widget.toArea, locationUser: widget.locationUser,
                                    ...
                                    onTap: (){
                                      ...
                                      Navigator.push(context, MaterialPageRoute
                                        (builder: (context) => FilterScreen(
                                          ...
                                          fromDownPayment: widget.fromDownPayment,
                                          toDownPayment: widget.toDownPayment,
                                          fromkiloMetresType: dummyKiloMeters[index].color,
                                          tokiloMetresType: widget.tokiloMetresType,
                                          cityName: widget.cityName,
                                          areaId: widget.areaId,
                                          amenitiesType: widget.amenitiesType,
