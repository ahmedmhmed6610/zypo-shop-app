...
class ChooseFurnishedProductScreen extends StatefulWidget {

  ChooseFurnishedProductScreen(
      {Key? key, this.governmentId, this.governmentName, this.cityId, this.cityName,this.whatsAppNumber,
        this.fuelTypeAr,this.bodyTypeAr,this.engineCapacityTypeAr,this.amenitiesTypeAr,this.colorTypeAr,this.furnishedType,
        ...
        this.levelType,this.year,this.typeFashions,this.typeWarrannt,this.typeHomeFurniture,this.bedroom,
        this.typeBusiness,this.typeKids,this.typeApartment,this.statusApartment,this.typeBooks,this.typeTransmission,this.typeCondtion,this.bathroom,this.downPayment,this.area,this.data,this.productId})
      : super(key: key);

  String? governmentId, governmentName,typeWarrannt,typeTransmission,whatsAppNumber;
  String? cityId, cityName,bedroom,bathroom,year,area,downPayment,furnishedType;
  String? areaId, areaName,typeFashions,typeHomeFurniture,typeBooks,typeKids;
  String? data,productId,typeCondtion,typeBusiness,typeApartment,statusApartment;
  ...
  @override
  State<ChooseFurnishedProductScreen> createState() => _ChooseFurnishedProductScreenState();
}

class _ChooseFurnishedProductScreenState extends State<ChooseFurnishedProductScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(LocaleKeys.condition.tr(),style: TextStyle(color: AppPalette.white),),
        elevation: 0.0,
        leading: InkWell(
          onTap: () {
                          ...
                          onTap: () {
                            Navigator.pushReplacement(context, MaterialPageRoute
                              (builder: (context) => ChangeProductScreen2(
                                ...
                                furnishedType: dummyFashionType[index].color,
