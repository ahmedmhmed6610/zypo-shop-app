...
class ChooseConditionProductScreen extends StatefulWidget {

  ChooseConditionProductScreen(
      {Key? key, this.governmentId, this.governmentName, this.cityId, this.cityName,this.whatsAppNumber,
        ...
        this.typeBusiness,this.typeKids,this.typeBooks,this.typeTransmission,this.typeCondtion,
        this.bathroom,this.downPayment,this.area,this.data,this.productId,this.furnishedType})
      : super(key: key);
  ...
  String? data,productId,typeCondtion,typeBusiness,furnishedType;
  ...
  @override
  State<ChooseConditionProductScreen> createState() => _ChooseConditionProductScreenState();
}

class _ChooseConditionProductScreenState extends State<ChooseConditionProductScreen> {


  List<ColorModel> dummyFashionType = [
    ColorModel(id: 1, color: LocaleKeys.newProd.tr()),
    ColorModel(id: 2, color: LocaleKeys.used.tr()),
  ];
                        ...
                        ListView.builder(
                          ...
                          itemBuilder: (context, index) => InkWell(
                            onTap: () {
                              Navigator.pushReplacement(context, MaterialPageRoute
                                (builder: (context) => ChangeProductScreen2(
                                  typeCondtion: dummyFashionType[index].color,
                                  governmentId: widget
                                      .governmentId,
                                  governmentName: widget
                                      .governmentName,
