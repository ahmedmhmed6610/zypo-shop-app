...
class ChooseFashionsProductScreen extends StatefulWidget {
  ...
  ChooseFashionsProductScreen(
      {Key? key, this.governmentId, this.governmentName, this.cityId, this.cityName,this.whatsAppNumber,
        ...
        this.levelType,this.year,this.typeFashions,this.typeCondtion,this.bedroom,this.bathroom,this.downPayment,this.area,this.data,this.productId})
      : super(key: key);
  ...
  @override
  State<ChooseFashionsProductScreen> createState() => _ChooseFashionsProductScreenState();
}

class _ChooseFashionsProductScreenState extends State<ChooseFashionsProductScreen> {


  List<ColorModel> dummyFashionType = [
    ColorModel(id: 1, color: LocaleKeys.nightwear.tr()),
    ColorModel(id: 2, color: LocaleKeys.swimwear.tr()),
    ColorModel(id: 3, color: LocaleKeys.dresses.tr()),
    ColorModel(id: 4, color: LocaleKeys.weddingApparel.tr()),
    ColorModel(id: 4, color: LocaleKeys.pulloverCoatsJackets.tr()),
    ColorModel(id: 4, color: LocaleKeys.blouseTshirtsTops.tr()),
    ColorModel(id: 4, color: LocaleKeys.trousersLeggingsJeans.tr()),
  ];
                          ...
                          onTap: () {
                            Navigator.pushReplacement(context, MaterialPageRoute
                              (builder: (context) => ChangeProductScreen2(
                                ...
                                typeFashion: dummyFashionType[index].color,
