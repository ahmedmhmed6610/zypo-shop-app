...
class ChooseBooksProductScreen extends StatefulWidget {
  ...
  ChooseBooksProductScreen(
      {Key? key, this.governmentId, this.governmentName, this.cityId, this.cityName,this.whatsAppNumber,
        ...
        this.levelType,this.year,this.typeCondtion,this.bedroom,this.typeBooks,this.bathroom,this.downPayment,this.area,this.data,this.productId})
      : super(key: key);
  ...
  String? data,productId,typeBooks;
  ...
  @override
  State<ChooseBooksProductScreen> createState() => _ChooseBooksProductScreenState();
}

class _ChooseBooksProductScreenState extends State<ChooseBooksProductScreen> {


  List<ColorModel> dummyBooks = [
    ColorModel(id: 1, color: LocaleKeys.antiques.tr()),
    ColorModel(id: 2, color: LocaleKeys.aRT.tr()),
    ColorModel(id: 3, color: LocaleKeys.collectibles.tr()),
    ColorModel(id: 4, color: LocaleKeys.oldCurrencies.tr()),
    ColorModel(id: 4, color: LocaleKeys.pensWritingInstruments.tr()),
                          ...
                          onTap: () {
                            Navigator.pushReplacement(context, MaterialPageRoute
                              (builder: (context) => ChangeProductScreen2(
                                ...
                                cityId: widget.cityId,
                                cityName: widget.cityName,
                                typeBooks: dummyBooks[index].color,
                                areaId: widget.areaId,
                                amenitiesType: widget.amenitiesType,
                                bodyType: widget.bodyType,
                                colorType: widget.colorType,
