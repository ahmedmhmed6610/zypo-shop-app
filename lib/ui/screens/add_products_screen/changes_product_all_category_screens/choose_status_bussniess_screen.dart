...
class ChooseBusinessProductScreen extends StatefulWidget {
  ...
  ChooseBusinessProductScreen(
      {Key? key, this.governmentId, this.governmentName, this.cityId, this.cityName,this.whatsAppNumber,
        ...
        this.levelType,this.year,this.typeCondtion,this.bedroom,this.typeBusiness,this.bathroom,this.downPayment,this.area,this.data,this.productId})
      : super(key: key);
  ...
  String? data,productId,typeBusiness;
  ...
  @override
  State<ChooseBusinessProductScreen> createState() => _ChooseBusinessProductScreenState();
}

class _ChooseBusinessProductScreenState extends State<ChooseBusinessProductScreen> {


  List<ColorModel> dummyBusiness = [
    ColorModel(id: 1, color: LocaleKeys.seeds.tr()),
    ColorModel(id: 2, color: LocaleKeys.crops.tr()),
    ColorModel(id: 3, color: LocaleKeys.farmMachinery.tr()),
    ColorModel(id: 4, color: LocaleKeys.pesticides.tr()),
                  ...
                  child: ListView(
                    children: [
                      ...
                      ListView.builder(
                        ...
                        itemCount: dummyBusiness.length,
                          ...
                          onTap: () {
                            Navigator.pushReplacement(context, MaterialPageRoute
                              (builder: (context) => ChangeProductScreen2(
                                ...
                                downPayment: widget.downPayment,
                                year: widget.year,
                                typeBusiness: dummyBusiness[index].color,
                                description: widget.description,
                                cityId: widget.cityId,
                                cityName: widget.cityName,
                                areaId: widget.areaId,
