...
class ChooseTypeApartmentProductScreen extends StatefulWidget {
  ...
  ChooseTypeApartmentProductScreen(
      {Key? key, this.governmentId, this.governmentName, this.cityId, this.cityName,this.whatsAppNumber,
        ...
        this.levelType,this.year,this.bedroom,this.bathroom,this.typeApartment,
  ...
  String? areaId, areaName,typeApartment,statusApartment,data,productId;
  ...
  @override
  State<ChooseTypeApartmentProductScreen> createState() => _ChooseTypeApartmentProductScreenState();
}

class _ChooseTypeApartmentProductScreenState extends State<ChooseTypeApartmentProductScreen> {

  ColorModel? selectedApartmentType;

  List<ColorModel> dummyApartmentType = [
    ColorModel(id: 1, color: LocaleKeys.apartment.tr()),
    ColorModel(id: 2, color: LocaleKeys.duplex.tr()),
    ColorModel(id: 3, color: LocaleKeys.penthouse.tr()),
    ColorModel(id: 4, color: LocaleKeys.studio.tr()),
  ];
                    ...
                    child: ListView(
                      children: [
                        ...
                        ListView.builder(
                          ...
                          itemCount: dummyApartmentType.length,
                            ...
                            onTap: () {
                              Navigator.pushReplacement(context, MaterialPageRoute
                                (builder: (context) => ChangeProductScreen2(
                                  ...
                                  cityId: widget.cityId,
                                  statusApartment: widget.statusApartment,
                                  typeApartment: dummyApartmentType[index].color,
                                  cityName: widget.cityName,
                                  areaId: widget.areaId,
                                  amenitiesType: widget.amenitiesType,
                                  bodyType: widget.bodyType,
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  12.widthBox,
                                  Text(
                                    dummyApartmentType[index].color,
